...
class AccountMoveImport(models.TransientModel):
    ...
    split_move_method = fields.Selection([
        ...
        help="If you select the method 'Balanced', Odoo will cut the move when a group of lines is balanced with the same journal and date. If you select the method 'Move Name', Odoo will cut the move using the field 'move_name' of the pivot format (this field is optional, but it will have to be present if you select this method).")
    ...
    def create_moves_from_pivot(self, pivot, post=False):
        ...
        for l in pivot:
            ...
            if split_move_method == 'move_name':
                if not move_name:
                    errors['other'].append(_(
                        'Line %d: missing move_name.') % l['line'])
